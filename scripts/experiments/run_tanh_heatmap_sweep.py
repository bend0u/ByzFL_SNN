...
def main():
    config_path = "configs/cnn_tanh_heatmap_sweep.json"
    results_dir = "results/cnn/tanh_heatmap_sweep"
    plots_dir = "plots/cnn_tanh_heatmaps"

    print("=" * 60)
    print("Starting CNN Tanh Heatmap Sweep (GM + NNM_ARC, f=0..5, γ=0..1, No Clip)")
    print("=" * 60)
    
    # Run the benchmark with 20 jobs, distributing across GPUs
