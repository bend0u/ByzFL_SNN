...
\begin{table}[htbp]
    ...
    \begin{tabular}{lccc}
        ...
        \midrule
        $\alpha = 1.0$ & 76.79\% & 12.63\% & 12.63\% \\
        $\alpha = 1.25$ & 73.88\% & 12.63\% & 12.63\% \\
        $\alpha = 1.5$ & 73.84\% & 12.63\% & 12.63\% \\
        $\alpha = 2.0$ & 71.59\% & 12.63\% & 12.63\% \\
        $\alpha = 3.0$ & 69.78\% & 12.63\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{ccccccc}
        ...
        & \textbf{f = 0} & \textbf{f = 1} & \textbf{f = 2} & \textbf{f = 3} & \textbf{f = 4} & \textbf{f = 5} \\
        \midrule
        $\gamma = 1.0$ & 97.01\% & 97.02\% & 97.09\% & 97.11\% & 97.20\% & 97.19\% \\
        $\gamma = 0.66$ & 97.10\% & 97.43\% & 97.37\% & 97.17\% & 97.01\% & 96.84\% \\
        $\gamma = 0.33$ & 97.04\% & 96.98\% & 95.77\% & 51.45\% & 14.81\% & 12.63\% \\
        $\gamma = 0.0$ & 97.04\% & 79.69\% & 23.57\% & 13.42\% & 12.63\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{ccccccc}
        ...
        & \textbf{f = 0} & \textbf{f = 1} & \textbf{f = 2} & \textbf{f = 3} & \textbf{f = 4} & \textbf{f = 5} \\
        \midrule
        $\gamma = 1.0$ & 97.36\% & 97.38\% & 97.42\% & 97.47\% & 97.50\% & 97.58\% \\
        $\gamma = 0.66$ & 97.37\% & 97.74\% & 97.45\% & 97.25\% & 97.22\% & 96.69\% \\
        $\gamma = 0.33$ & 97.31\% & 97.05\% & 95.82\% & 51.96\% & 18.64\% & 12.63\% \\
        $\gamma = 0.0$ & 97.39\% & 72.43\% & 22.55\% & 12.63\% & 12.63\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{ccccccc}
        ...
        & \textbf{f = 0} & \textbf{f = 1} & \textbf{f = 2} & \textbf{f = 3} & \textbf{f = 4} & \textbf{f = 5} \\
        \midrule
        $\gamma = 1.0$ & 97.82\% & 97.83\% & 97.88\% & 97.90\% & 97.83\% & 97.90\% \\
        $\gamma = 0.66$ & 97.85\% & 97.96\% & 97.86\% & 97.48\% & 97.24\% & 85.48\% \\
        $\gamma = 0.33$ & 97.81\% & 96.83\% & 95.80\% & 16.78\% & 12.63\% & 12.63\% \\
        $\gamma = 0.0$ & 97.79\% & 69.68\% & 19.39\% & 12.63\% & 12.63\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{ccccccc}
        ...
        & \textbf{f = 0} & \textbf{f = 1} & \textbf{f = 2} & \textbf{f = 3} & \textbf{f = 4} & \textbf{f = 5} \\
        \midrule
        $\gamma = 1.0$ & 98.19\% & 98.27\% & 98.24\% & 98.21\% & 98.21\% & 98.19\% \\
        $\gamma = 0.66$ & 98.23\% & 98.28\% & 98.02\% & 97.94\% & 97.10\% & 71.09\% \\
        $\gamma = 0.33$ & 98.17\% & 90.11\% & 77.40\% & 12.63\% & 12.63\% & 12.63\% \\
        $\gamma = 0.0$ & 98.11\% & 72.11\% & 13.18\% & 12.63\% & 12.63\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
