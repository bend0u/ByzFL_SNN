...
\title{SNN Surrogate Gradient $\alpha$ Parameter Comparison\\Robustness Sweep under Data Heterogeneity ($f \le 4$)}
...
\begin{itemize}
    ...
    \item \textbf{Byzantine Nodes}: $f \in \{0, 1, 2, 3, 4\}$ out of $N=10$ honest nodes
...
\begin{figure}[htbp]
    ...
    \caption{Aggregated Test Accuracy Heatmaps across different surrogate gradient $\alpha$ values for SNN ($f \le 4$).}
...
Table~\ref{tab:summary} compares the overall performance metrics for each $\alpha$ parameter value. The metrics include the average accuracy across all 20 cells in the grid, the worst-case accuracy, and the accuracy under the most challenging experimental setup ($\gamma=0.0$, $f=4$).
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lccc}
        \toprule
        \textbf{Surrogate Scaling ($\alpha$)} & \textbf{Average Accuracy} & \textbf{Worst-case Accuracy} & \textbf{Accuracy ($\gamma=0.0, f=4$)} \\
        \midrule
        $\alpha = 1.0$ & 81.15\% & 12.63\% & 12.63\% \\
        $\alpha = 1.25$ & 77.70\% & 12.63\% & 12.63\% \\
        $\alpha = 1.5$ & 77.63\% & 12.63\% & 12.63\% \\
        $\alpha = 2.0$ & 75.48\% & 12.63\% & 12.63\% \\
        $\alpha = 3.0$ & 74.01\% & 12.63\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccccc}
        \toprule
        & \textbf{f = 0} & \textbf{f = 1} & \textbf{f = 2} & \textbf{f = 3} & \textbf{f = 4} \\
        \midrule
        $\gamma = 1.0$ & 96.43\% & 96.42\% & 96.48\% & 96.52\% & 96.60\% \\
        $\gamma = 0.66$ & 96.43\% & 96.90\% & 96.98\% & 96.75\% & 96.66\% \\
        $\gamma = 0.33$ & 96.46\% & 96.45\% & 95.44\% & 90.66\% & 16.66\% \\
        $\gamma = 0.0$ & 96.41\% & 84.02\% & 53.80\% & 14.22\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccccc}
        ...
        & \textbf{f = 0} & \textbf{f = 1} & \textbf{f = 2} & \textbf{f = 3} & \textbf{f = 4} \\
        \midrule
        $\gamma = 1.0$ & 97.01\% & 97.02\% & 97.09\% & 97.11\% & 97.20\% \\
        $\gamma = 0.66$ & 97.10\% & 97.43\% & 97.37\% & 97.17\% & 97.01\% \\
        $\gamma = 0.33$ & 97.04\% & 96.98\% & 95.77\% & 51.45\% & 14.81\% \\
        $\gamma = 0.0$ & 97.04\% & 79.69\% & 23.57\% & 13.42\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccccc}
        ...
        & \textbf{f = 0} & \textbf{f = 1} & \textbf{f = 2} & \textbf{f = 3} & \textbf{f = 4} \\
        \midrule
        $\gamma = 1.0$ & 97.36\% & 97.38\% & 97.42\% & 97.47\% & 97.50\% \\
        $\gamma = 0.66$ & 97.37\% & 97.74\% & 97.45\% & 97.25\% & 97.22\% \\
        $\gamma = 0.33$ & 97.31\% & 97.05\% & 95.82\% & 51.96\% & 18.64\% \\
        $\gamma = 0.0$ & 97.39\% & 72.43\% & 22.55\% & 12.63\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccccc}
        ...
        & \textbf{f = 0} & \textbf{f = 1} & \textbf{f = 2} & \textbf{f = 3} & \textbf{f = 4} \\
        \midrule
        $\gamma = 1.0$ & 97.82\% & 97.83\% & 97.88\% & 97.90\% & 97.83\% \\
        $\gamma = 0.66$ & 97.85\% & 97.96\% & 97.86\% & 97.48\% & 97.24\% \\
        $\gamma = 0.33$ & 97.81\% & 96.83\% & 95.80\% & 16.78\% & 12.63\% \\
        $\gamma = 0.0$ & 97.79\% & 69.68\% & 19.39\% & 12.63\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccccc}
        ...
        & \textbf{f = 0} & \textbf{f = 1} & \textbf{f = 2} & \textbf{f = 3} & \textbf{f = 4} \\
        \midrule
        $\gamma = 1.0$ & 98.19\% & 98.27\% & 98.24\% & 98.21\% & 98.21\% \\
        $\gamma = 0.66$ & 98.23\% & 98.28\% & 98.02\% & 97.94\% & 97.10\% \\
        $\gamma = 0.33$ & 98.17\% & 90.11\% & 77.40\% & 12.63\% & 12.63\% \\
        $\gamma = 0.0$ & 98.11\% & 72.11\% & 13.18\% & 12.63\% & 12.63\% \\
        \bottomrule
    \end{tabular}
\end{table}
