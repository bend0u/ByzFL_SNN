...
# RCP Sweep Runner - Optimized for 3x H100 GPUs (12 parallel jobs distributed across GPUs)
...
echo "========================================="
echo "Starting RCP Sweep on 3 GPUs"
echo "  - 12 parallel jobs distributed across GPUs"
