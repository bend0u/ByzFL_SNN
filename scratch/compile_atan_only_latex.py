...
def make_figure_latex(title_caption, label_prefix, path_prefix, filename, alphas):
    latex = []
    ...
    for idx, alpha in enumerate(alphas):
        ...
        sub_fig = (
            f"    \\begin{{subfigure}}[b]{{{sub_width}}}\n"
            f"        \\centering\n"
            f"        \\includegraphics[width=\\textwidth]{{{path_prefix}/alpha_{alpha}/{filename}}}\n"
            f"        \\caption{{$\\alpha = {alpha}$}}\n"
            f"        \\label{{fig:{label_prefix}_alpha_{str(alpha).replace('.', '_')}}}\n"
            f"    \\end{{subfigure}}"
        )
...
def main():
    ...
    alphas = ["0.5", "0.75", "1.0", "1.2", "1.4", "1.5", "2.0"]
    path_prefix = "../plots/robust_new_atan_sweep"

    tex_path = os.path.join(latex_dir, "robust_atan_sweep_report.tex")
...
""")
        f.write(make_figure_latex(
            "Best overall test accuracy heatmaps (worst-case across attacks) for different $\\alpha$ stiffness parameter values.",
...
""")
        f.write(make_figure_latex(
            "Best test accuracy heatmaps under the Optimal ALIE attack for different $\\alpha$ parameter values.",
...
""")
        f.write(make_figure_latex(
            "Best test accuracy heatmaps under the Sign Flipping attack for different $\\alpha$ parameter values.",
            "best_sf", path_prefix,
...
""")
        f.write(make_figure_latex(
            "Best test accuracy heatmaps under the Optimal Inner Product Manipulation attack for different $\\alpha$ parameter values.",
...
""")
        ...
        f.write(make_figure_latex(
            "Centered Clipping performance under the worst-case across all attacks across $\\alpha$ values.",
        ...
        f.write(make_figure_latex(
            "Centered Clipping performance under Optimal ALIE across $\\alpha$ values.",
            "cc_alie", path_prefix,
        ...
        f.write(make_figure_latex(
            "Centered Clipping performance under Sign Flipping across $\\alpha$ values.",
            "cc_sf", path_prefix,
        ...
        f.write(make_figure_latex(
            "Centered Clipping performance under Optimal Inner Product Manipulation across $\\alpha$ values.",
            "cc_ipm", path_prefix,
...
""")
        ...
        f.write(make_figure_latex(
            "Geometric Median performance under the worst-case across all attacks across $\\alpha$ values.",
        ...
        f.write(make_figure_latex(
            "Geometric Median performance under Optimal ALIE across $\\alpha$ values.",
            "gm_alie", path_prefix,
        ...
        f.write(make_figure_latex(
            "Geometric Median performance under Sign Flipping across $\\alpha$ values.",
            "gm_sf", path_prefix,
        ...
        f.write(make_figure_latex(
            "Geometric Median performance under Optimal Inner Product Manipulation across $\\alpha$ values.",
            "gm_ipm", path_prefix,
...
""")
        ...
        f.write(make_figure_latex(
            "Multi-Krum performance under the worst-case across all attacks across $\\alpha$ values.",
        ...
        f.write(make_figure_latex(
            "Multi-Krum performance under Optimal ALIE across $\\alpha$ values.",
            "mk_alie", path_prefix,
        ...
        f.write(make_figure_latex(
            "Multi-Krum performance under Sign Flipping across $\\alpha$ values.",
            "mk_sf", path_prefix,
        ...
        f.write(make_figure_latex(
            "Multi-Krum performance under Optimal Inner Product Manipulation across $\\alpha$ values.",
            "mk_ipm", path_prefix,
...
""")
        ...
        f.write(make_figure_latex(
            "Trimmed Mean performance under the worst-case across all attacks across $\\alpha$ values.",
        ...
        f.write(make_figure_latex(
            "Trimmed Mean performance under Optimal ALIE across $\\alpha$ values.",
            "tm_alie", path_prefix,
        ...
        f.write(make_figure_latex(
            "Trimmed Mean performance under Sign Flipping across $\\alpha$ values.",
            "tm_sf", path_prefix,
        ...
        f.write(make_figure_latex(
            "Trimmed Mean performance under Optimal Inner Product Manipulation across $\\alpha$ values.",
            "tm_ipm", path_prefix,
    ...
    try:
        ...
        for ext in [".aux", ".log", ".out", ".toc", ".fls", ".fdb_latexmk", ".synctex.gz"]:
            ...
            if os.path.exists(aux_file):
                os.remove(aux_file)
        print(f"LaTeX report compiled successfully: robust_atan_sweep_report.pdf")
