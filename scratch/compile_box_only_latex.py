...
def main():
    ...
    betas = ["0.25", "0.5", "0.75", "1.0", "1.25", "2.0"]
    path_prefix = "../plots/robust_new_box_sweep"

    tex_path = os.path.join(latex_dir, "robust_box_sweep_report.tex")
    ...
    try:
        ...
        for ext in [".aux", ".log", ".out", ".toc", ".fls", ".fdb_latexmk", ".synctex.gz"]:
            ...
            if os.path.exists(aux_file):
                os.remove(aux_file)
        print(f"LaTeX report compiled successfully: robust_box_sweep_report.pdf")
