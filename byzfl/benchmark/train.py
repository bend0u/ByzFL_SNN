...
def start_training(params):
    ...
    honest_clients = [
        Client({
            ...
            "layer_grad_clip_val": params_manager.get_honest_clients_layer_grad_clip_val(),
            "self_grad_clip_warmup": params_manager.get_honest_clients_self_grad_clip_warmup(),
            "self_grad_clip_margin": params_manager.get_honest_clients_self_grad_clip_margin(),
            ...
            "raw_grad_clip_quantile": params_manager.get_honest_clients_raw_grad_clip_quantile(),
            "raw_grad_clip_window": params_manager.get_honest_clients_raw_grad_clip_window(),
