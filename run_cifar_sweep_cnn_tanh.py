...
def main():
    ...
    config_path = os.environ.get("CONFIG_PATH", "configs/cifar_sweep_cnn_tanh.json")

    print("=" * 60)
    print("CIFAR-10 Sweep: CNN (Tanh)")
    ...
    print("Sweep completed! Results are in results/cifar_sweep_cnn_tanh")
